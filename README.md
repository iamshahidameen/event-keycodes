...
On loading when you enter any key from keyboard, it will return us the event keyCode, code and name of the key. Possible using event listener “keydown. 

Project Demo: [https://event-keycode-by-shahid.netlify.app/](https://event-keycode-by-shahid.netlify.app/)
